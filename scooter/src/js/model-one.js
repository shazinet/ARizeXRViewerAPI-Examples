arize.start('3dviewer', {
    'glbURL': 'https://demo.arize.io/scooter/src/3d/scooter.glb',
...
const texture1 = 'https://demo.arize.io/scooter/src/3d/MainBody/M_2K_1_Base_color1.jpg';
const texture2 = 'https://demo.arize.io/scooter/src/3d/MainBody/M_2K_1_Base_color2.jpg';
const texture3 = 'https://demo.arize.io/scooter/src/3d/MainBody/M_2K_1_Base_color3.jpg';
const texture4 = 'https://demo.arize.io/scooter/src/3d/MainBody/M_2K_1_Base_color4.jpg';

const texture5 = 'https://demo.arize.io/scooter/src/3d/Stem/M_1K_1_Base_color1.jpg';
const texture6 = 'https://demo.arize.io/scooter/src/3d/Stem/M_1K_1_Base_color2.jpg';
const texture7 = 'https://demo.arize.io/scooter/src/3d/Stem/M_1K_1_Base_color3.jpg';
const texture8 = 'https://demo.arize.io/scooter/src/3d/Stem/M_1K_1_Base_color4.jpg';
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (textureTwoThree) {
        textureTwoThree.onclick = function () {
            arize.updateTexture(arize.rootEntity.children[5].render.meshInstances[0].material, texture7);
        }
    }
    ...
    if (textureTwoFour) {
        textureTwoFour.onclick = function () {
            arize.updateTexture(arize.rootEntity.children[5].render.meshInstances[0].material, texture8);
        }
    }
