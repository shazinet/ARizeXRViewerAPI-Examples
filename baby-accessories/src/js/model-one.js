arize.start('3dviewer', {
    'glbURL': 'https://demo.arize.io/baby-accessories/src/3d/stroller.glb',
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Seven
    var colorPickerSeven = document.getElementById('colorPickerSeven');
    if (colorPickerSeven) {
        colorPickerSeven.onchange = function () {
            var rgbColor = hexToRgb(colorPickerSeven.value);
            arize.changeMatColor(arize.rootEntity.children[6].render.meshInstances[0].material, rgbColor.r, rgbColor.g, rgbColor.b, 1);
            console.log('colorPickerSeven: ' + 'rgba(' + rgbColor.r + ',' + rgbColor.g + ',' + rgbColor.b + ',1)');
        }
    }
